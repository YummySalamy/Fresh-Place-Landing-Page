...
import LimeShoppingImage from "images/groceries-shopping-1.jpeg";
...
export default ({
  subheading = "",
  heading = "Questions",
  description = "Here are some frequently asked questions about our company. If you have any other questions, feel free to reach out to us",
  imageSrc = LimeShoppingImage,
  imageContain = false,
  imageShadow = true,
  faqs = null
}) => {
  ...
  const defaultFaqs = [
    ...
    },
    {
      ...
      answer:
        "You can track your order by clicking the link in your email.",
    },
  ];
