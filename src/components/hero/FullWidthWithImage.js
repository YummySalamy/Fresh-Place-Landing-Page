...
import LimeExhibition from "../../images/lime-exhibition-1.jpeg";
...
const RightColumn = styled.div`
  background-image: url("${LimeExhibition}");
...
export default ({
  heading = (
    <>
      <span tw="text-gray-700">Welcome To Our</span>
      <wbr />
      <br />
      <span tw="text-primary-500">Fresh Place</span>
    </>
  ),
